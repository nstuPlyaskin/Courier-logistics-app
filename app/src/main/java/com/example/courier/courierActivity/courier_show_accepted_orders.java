...
public class courier_show_accepted_orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_courier_show_accepted_orders);
        init();
        getDataFromDB();
        setOnClickItem();
    }
    ...
    private void init(){
        listView = findViewById(R.id.listViewReadAcceptedOrdersCourier);
        listData = new ArrayList<>();
        listOrder = new ArrayList<>();
        adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, listData);
        listView.setAdapter(adapter);
        dbCouriers = FirebaseDatabase.getInstance().getReference(COURIER_KEY);
        root = findViewById(R.id.root_courier_accepted_orders);
    }
    ...
    private void setOnClickItem(){
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(courier_show_accepted_orders.this, show_courier_item_accepted_orders.class);
